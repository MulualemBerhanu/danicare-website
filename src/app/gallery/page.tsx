              ...
              <div key={amenity.title} className="group">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl border border-white/30 shadow-xl group-hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 p-8 h-full">
                  <div className="text-center">
                    ...
                    <p className="text-gray-900 leading-relaxed">{amenity.description}</p>
                  </div>
                </div>
              </div>
            ))}
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl border border-white/30 shadow-xl group-hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 p-8">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start space-x-3">
                      ...
                      <span className="text-gray-900">Wheelchair accessible entrances and pathways</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-warm-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-900">Handrails and grab bars in key areas</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-warm-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-900">Accessible restrooms and facilities</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-warm-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-900">Emergency call systems throughout</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="group">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl border border-white/30 shadow-xl group-hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 p-8">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-warm-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-900">24/7 monitoring and security</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-warm-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-900">Emergency response systems</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-warm-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-900">Well-lit common areas</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-warm-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-900">Secure entry systems</span>
                    </li>
                  </ul>
                </div>
              </div>
