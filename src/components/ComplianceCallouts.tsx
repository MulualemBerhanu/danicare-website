...
export function LanguageAccessNotice() {
  return (
    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
      <div className="flex items-start space-x-3">
        <Languages className="h-6 w-6 text-blue-600 mt-0.5 flex-shrink-0" />
        <div>
          <h3 className="text-lg font-semibold text-blue-900 mb-2">
            Language Access
          </h3>
          <p className="text-blue-800">
            {siteData.languageAccess.blurb} Please contact us if you need assistance in your preferred language.
          </p>
        </div>
      </div>
    </div>
...
export function NoPHINotice() {
  return (
    <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
      <div className="flex items-start space-x-3">
        <Shield className="h-6 w-6 text-gray-600 mt-0.5 flex-shrink-0" />
        <div>
