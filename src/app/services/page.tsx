              ...
              <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl border border-white/30 shadow-xl group-hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 p-8 h-full">
                <div className="flex items-start space-x-6 mb-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-900 leading-relaxed">Comprehensive medical care and support for complex health needs.</p>
                  </div>
                </div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-warm-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-900"><strong>IV therapy</strong> and medication management</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-warm-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-900"><strong>Wound care</strong> and treatment</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-warm-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-900"><strong>Ventilator support</strong> for respiratory needs</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-warm-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-900"><strong>Feeding tube</strong> management and care</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-warm-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-900"><strong>Tracheostomy care</strong> and monitoring</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl border border-white/30 shadow-xl group-hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 p-8 h-full">
                <div className="flex items-start space-x-6 mb-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-900 leading-relaxed">Advanced safety systems and security measures for complete protection.</p>
                  </div>
                </div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-warm-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-900"><strong>Fire sprinkler system</strong> for complete fire protection</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-warm-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-900"><strong>Backup generator</strong> for power outage protection</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-warm-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-900"><strong>Clean, loving environment</strong> with quality care</span>
                  </li>
                </ul>
              </div>
            </div>
                ...
                <div className="relative">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-center gap-3">
                      ...
                      <span className="text-lg font-semibold text-gray-900">24-Hour Residential Services</span>
                    </div>
                    <div className="flex items-center justify-center gap-3">
                      <CheckCircle className="h-6 w-6 text-warm-600 flex-shrink-0" />
                      <span className="text-lg font-semibold text-gray-900">Direct Nursing Services (effective Dec 20, 2024)</span>
                    </div>
                  </div>
