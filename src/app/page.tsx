        ...
        <div className="absolute inset-0 w-full h-full">
          <video
            ...
            onError={(e) => {
              ...
              const fallback = document.getElementById('fallback-gradient');
          ...
          <div id="fallback-gradient" className="absolute inset-0 w-full h-full bg-gradient-to-br from-dani-900 via-dani-800 to-warm-900" style={{display: 'none'}}>
                ...
                <div className="group">
                  <div className="flex items-start space-x-4 p-4 rounded-2xl bg-white/60 backdrop-blur-sm border border-white/30 hover:bg-white/80 transition-all duration-500 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 text-sm leading-relaxed">Professional caregivers with full certification</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group">
                  <div className="flex items-start space-x-4 p-4 rounded-2xl bg-white/60 backdrop-blur-sm border border-white/30 hover:bg-white/80 transition-all duration-500 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 text-sm leading-relaxed">Specialized care for complex medical needs</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group">
                  <div className="flex items-start space-x-4 p-4 rounded-2xl bg-white/60 backdrop-blur-sm border border-white/30 hover:bg-white/80 transition-all duration-500 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 text-sm leading-relaxed">Fully wheelchair accessible facilities</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group">
                  <div className="flex items-start space-x-4 p-4 rounded-2xl bg-white/60 backdrop-blur-sm border border-white/30 hover:bg-white/80 transition-all duration-500 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 text-sm leading-relaxed">Spacious private rooms with luxury features</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="group">
                  <div className="flex items-start space-x-4 p-4 rounded-2xl bg-white/60 backdrop-blur-sm border border-white/30 hover:bg-white/80 transition-all duration-500 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 text-sm leading-relaxed">Advanced fire protection & backup systems</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group">
                  <div className="flex items-start space-x-4 p-4 rounded-2xl bg-white/60 backdrop-blur-sm border border-white/30 hover:bg-white/80 transition-all duration-500 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 text-sm leading-relaxed">Highly qualified professionals</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group">
                  <div className="flex items-start space-x-4 p-4 rounded-2xl bg-white/60 backdrop-blur-sm border border-white/30 hover:bg-white/80 transition-all duration-500 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 text-sm leading-relaxed">Premium nutritious meals included</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group">
                  <div className="flex items-start space-x-4 p-4 rounded-2xl bg-white/60 backdrop-blur-sm border border-white/30 hover:bg-white/80 transition-all duration-500 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 text-sm leading-relaxed">Round-the-clock emergency response</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {trustBadges.map((badge, index) => (
              <div key={badge.title} className="group">
                <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-white/20">
                  ...
                  <p className="text-gray-900 leading-relaxed">{badge.description}</p>
                </div>
              </div>
            ))}
          </div>
